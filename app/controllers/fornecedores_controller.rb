class FornecedoresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fornecedor.save
        format.html { redirect_to fornecedor_url(@fornecedor), notice: "Fornecedor foi criado." }
  ...
  def update
    respond_to do |format|
      if @fornecedor.update(fornecedor_params)
        format.html { redirect_to fornecedor_url(@fornecedor), notice: "Fornecedor foi atualizado." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to fornecedores_url, notice: "Fornecedor foi apagado." }
